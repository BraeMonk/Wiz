...
const WizardDungeonCrawler = () => {
    ...
    const castCurrentSpell = useCallback(() => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <button
                                            ...
                                            disabled={!canAfford}
                                            className={`w-full py-2 rounded text-white font-bold ${canAfford
                ...
                <div className="w-full h-screen bg-gradient-to-b from-indigo-900 via-purple-900 to-black flex flex-col">
                        ...
                        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-4">
                            {Object.values(ALL_SPELLS).map(spell => {
                                ...
                                return (
                                    <div
                                        key={spell.key}
                                        className={`bg-black bg-opacity-60 p-4 rounded-lg border-2 ${equipped
                                                ? 'border-yellow-400'
                                                : owned
                                                    ? 'border-green-600'
                                                    : 'border-gray-600'
                    ...
                    <div className="px-4 py-3 bg-black bg-opacity-30">
                        <button
                            ...
                            className={`w-full text-white font-bold py-3 px-8 rounded-lg text-lg ${equippedSpells.length === 0
                                    ? 'bg-gray-600'
                                    : 'bg-purple-600 hover:bg-purple-700'
                                }`}
                        >
        ...
        if (gameState === 'victory') {
            ...
            return (
                <div
                    className={`w-full h-screen bg-gradient-to-b ${isBossLevel
            ...
            <div className="w-full h-screen bg-black overflow-hidden relative touch-none">
                ...
                <div className="absolute top-0 left-0 right-0 p-2 md:p-4 pointer-events-none">
                    <div className="flex justify-between items-start">
                        <div
                            className={`bg-black bg-opacity-60 rounded-lg ${isMobile ? 'p-2 w-36' : 'p-3 md:p-4 w-52 md:w-64'
                                }`}
                        >
                            {!isMobile && (
                        ...
                        {equippedSpells.map((spell, index) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`bg-black bg-opacity-70 p-2 md:p-3 rounded-lg border-2 transition-all relative ${isSelected
